const Sidebar = ({ activeTab, setActiveTab, darkMode, toggleDarkMode }) => {
  const menuItems = [
    ...
    { key: 'active-orders', label: 'Pedidos Activos', icon: '📦' },
    { key: 'delivered-orders', label: 'Pedidos Entregados', icon: '✅' },
    { key: 'cancelled-orders', label: 'Pedidos Cancelados', icon: '❌' },
    { key: 'change-credentials', label: 'Cambiar Credenciales', icon: '🔐' },
  ]
